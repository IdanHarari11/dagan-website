...
const goals = [
  {
    title: 'פיתוח מנהיגים ומנהיגות מכלל חלקי החברה הישראלית',
  ...
  {
    title: 'פיתוח כלים למנהיגות, חשיבה מערכתית והובלת שינוי',
  ...
  {
    title: 'העמקת ההיכרות עם אתגרי החברה הישראלית ופיתוח דרכי פעולה',
  ...
  {
    title: 'יצירת רשת קשרים משמעותית ושיתופי פעולה חוצי מגזרים',
  ...
  {
    title: 'טיפוח יוזמות ושיתופי פעולה ליצירת שינוי והשפעה',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-20 relative overflow-hidden">
          ...
          <div className="relative z-10 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-xl">
            <h1 className="text-3xl md:text-4xl font-bold text-center text-blue-700 dark:text-blue-300 mb-6">תכנית דגן למנהיגות</h1>
            
            <div className="max-w-4xl mx-auto text-right text-gray-800 dark:text-gray-200 leading-relaxed text-lg space-y-5" dir="rtl">
              <p>
                החברה הישראלית מתמודדת עם מציאות מורכבת ומתמשכת של קיטוב, חוסר אמון ואתגרים מערכתיים. דווקא בתוך מציאות זו נדרשת מנהיגות ערכית, בעלת אחריות משותפת, המסוגלת לפעול בתוך מחלוקות, לבנות אמון ולהוביל שיתופי פעולה משמעותיים.
              </p>
              <p>
                תכנית דגן למנהיגות מפגישה מנהלים ומנהלות בעמדות השפעה מכלל חלקי החברה הישראלית, למסע אישי וקבוצתי של פיתוח מנהיגות במציאות מורכבת. התכנית משלבת למידה חווייתית, סיורים, מפגשים עם דמויות מפתח מהחברה הישראלית, חשיפה לקולות ולנקודות מבט מגוונות, ורכישת כלים לחשיבה אסטרטגית, הובלת שינוי ומנהיגות מגשרת.
              </p>
              <p>
                בנוסף לתכני התכנית, היא בונה רשת קשרים משמעותית וקהילת בוגרים פעילה, הממשיכות לייצר שיתופי פעולה והשפעה בתוך הקהילות והחברה.
              </p>
            </div>
        ...
        <p className="text-lg text-center text-gray-700 dark:text-gray-300 mb-12 max-w-3xl mx-auto">
          תכנית דגן למנהיגות מכוונת להשגת מספר מטרות משמעותיות  <br/> שמטרתן ליצור שינוי חברתי ארוך טווח
        </p>
