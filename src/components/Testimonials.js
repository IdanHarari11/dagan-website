...
export default function Testimonials({ title }) {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      image: '/images/testimonials/וואפאבלאן.jpeg',
      ...
      fullText: `תכנית דגן למנהיגות תרמה רבות לפיתוח יכולות המנהיגות שלי, הדגישה את חשיבות המנהיגות האנושית והמקצועית, והרחיבה את מעגל הקשרים שלי. ללא ספק, החוויה המעשירה הייתה חלק מהותי מאד בהתפתחותי המקצועית.`
    },
    {
      name: 'רועי כחלון',
      cycle: "בוגר מחזור ב'", 
      role: 'מנהל רשות החברות הממשלתיות',
      image: '/images/testimonials/רועיכחלון.jpg',
    ...
    },
    {
      ...
      image: '/images/testimonials/דניאדינואבבה.jpg',
    ...
    },
    {
      ...
      image: '/images/testimonials/אינאסחוואדכוור.jpg',
      text: 'בוגרת קורס תכנית דגן למנהיגות, הובלתי תהליכים משמעותיים בגליל. כיום אני מובילה את עמותת חכיאת ומחברת בין נשים יהודיות וערביות.',
      fullText: `אני בוגרת קורס תכנית דגן למנהיגות, ובמהלך התהליך שעברתי הצלחתי לצמוח ולהוביל תהליכים משמעותיים בגליל. במהלך תקופת המלחמה, הובלתי יחד עם קבוצת מתנדבים מוקד סיוע לחיילים ולכיתות הכוננות בגזרה הצפונית, בעזרת תורמים ואנשים שהכרתי במהלך קורס דגן והנטוורקינג. השנה החלטתי להוביל את עמותת חכיאת, אשר מקדמת את החיבור בין נשים יהודיות וערביות באזור הגליל, ובפרט סניף קליקה תפן. בנוסף, אני פעילה בעמותת "פסיפס אנושי גלילי", הפועלת לחיבור הקהילה דרך ספורט. לפני קורס דגן היו לי המון חלומות שהרגשתי שלא הצלחתי לקדם, וכיום אני מובילה תהליכים בזכות הזרעים שנזרעו במהלך הקורס ואחריו!`
    },
    {
      name: 'אורן שלו',
      cycle: "בוגר מחזור ב'",
      role: 'מייסד התאחדות יועצי המשכנתאות וסגן יו\'ר העמותה, מרצה בכיר ליועצים',
      image: '/images/testimonials/אורןשלו.jpg',
    ...
    },
    {
      ...
      image: '/images/testimonials/רמהפיליפס.jpeg',
