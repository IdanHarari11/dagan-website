  ...
  const testimonials = [
    {
      ...
      image: '/images/testimonials/מאיה קדוש.jpg',
      text: 'השתתפותי בתוכנית "דגן למנהיגות מגשרת" חיזקה את יכולות הגישור וההידברות שלי, העמיקה את הבנתי כחלק מהחברה וכדיפלומטית, וחידדה בי את חשיבות בניית האמון והשיח הפתוח.',
      fullText: `עדות על ההשתתפות בתכנית: השתתפותי בתוכנית "דגן למנהיגות מגשרת" הייתה חוויה משמעותית שהעניקה לי כלים חשובים לדיאלוג ולהבנה בין מגזרים שונים בחברה הישראלית. התוכנית אפשרה לי לחוות אתגרי גישור והידברות מזווית חדשה, לעבוד עם אנשים מכל חלקי החברה ולחדד את היכולת להקשיב ולהבין את הצרכים והמכנים המשותפים של אחרים. כמי שעוסקת בדיפלומטיה, אני יודעת כמה חשיבות יש בבניית אמון ושיח פתוח, וההשתתפות בתוכנית חיזקה בי את התחושות הללו, במיוחד אחרי האירועים הקשים של ה-7/10. החיבור עם אנשים מגוונים ומחויבים לחברה הישראלית היה ערך גדול עבורי, וההבנה העמוקה יותר של החברה הישראלית שצברתי עזרה לי לא רק כמנהיגה אלא גם כדיפלומטית. אני ממליצה בחום לכל מי שמאמין בכוחו של שיח מחבר להצטרף לתוכנית ולהיות חלק מהשינוי החיובי שהחברה שלנו צריכה.`
    },
    {
      name: 'ד"ר וואפא בלאן',
      cycle: "בוגרת מחזור א'",
      ...
      image: '/images/testimonials/וואפא בלאן.jpg',
      ...
      fullText: `תוכנית "דגן למנהיגות מגשרת" תרמה רבות לפיתוח יכולות המנהיגות שלי, הדגישה את חשיבות המנהיגות האנושית והמקצועית, והרחיבה את מעגל הקשרים שלי. ללא ספק, החוויה המעשירה הייתה חלק מהותי מאד בהתפתחותי המקצועית.`
    },
    {
      name: 'רועי כחלון',
      cycle: "בוגר מחזור ב'", 
      ...
      תכנית דגן הייתה עבורי הזדמנות ייחודית להכיר מקרוב מנהיגים מכל שכבות החברה הישראלית ולהבין את האתגרים והצרכים של קהילות שונות. 
      
      כמנהל רשות החברות הממשלתיות, אני מיישם רבים מהעקרונות והתובנות שרכשתי בתכנית בעבודתי היומיומית. אני מאמין שמנהיגות אמיתית מתחילה בהקשבה והבנה של הצד השני, וזה בדיוק מה שתכנית דגן מלמדת.`
    },
    {
      name: 'דני אדינו-אבבה',
      cycle: "בוגר מחזור א'",
      ...
      fullText: `הייתי חניך במחזור הראשון של "תכנית דגן" – אחת החוויות המשמעותיות והמעצימות ביותר שחוויתי. התכנית העניקה לי לא רק ידע, אלא שינוי תפיסתי עמוק.
      
      כיוצא אתיופיה וכמי שעוסק בתקשורת והסברה, תכנית דגן פתחה בפניי צוהר להבנה עמוקה יותר של המורכבות החברתית בישראל. למדתי כיצד לתקשר באופן אפקטיבי עם קהלים מגוונים ולהעביר מסרים באופן שמכבד את השונות התרבותית.
      
      הקשרים שיצרתי במהלך התכנית ממשיכים ללוות אותי בעבודתי במשרד העלייה והקליטה, ומסייעים לי להבין טוב יותר את האתגרים העומדים בפני עולים חדשים מרקעים שונים. אני גאה להיות חלק מקהילת בוגרי דגן ולהמשיך את דרכו של מאיר דגן ז"ל בבניית חברה ישראלית מלוכדת ומכילה.`
    },
    {
      ...
      התכנית העניקה לי כלים מעשיים להובלת שינוי חברתי ולגישור בין קהילות. דרך המפגשים והסדנאות, למדתי כיצד לבנות גשרים של הבנה והערכה הדדית בין נשים מרקעים שונים.
      
      הקשרים שיצרתי במהלך התכנית ממשיכים ללוות אותי עד היום ומהווים רשת תמיכה משמעותית בעבודתי החברתית. אני מאמינה שדרך שיתוף פעולה והיכרות אמיתית, ניתן לבנות חברה טובה יותר.`
    },
    {
      name: 'אורן שלו',
      cycle: "בוגר מחזור ב'",
      ...
      fullText: `הצטרפתי לתכנית כדי לחזק את המיומנויות המנהיגותיות שבי. הכרתי אנשים שלא דמיינתי שאכיר והתחזקתי במיומנויות המנהיגות.
      
      תכנית דגן פתחה בפניי עולמות חדשים של הבנה חברתית ותרבותית. כמי שעוסק בתחום הפיננסי, למדתי להסתכל מעבר למספרים ולראות את האנשים והסיפורים שמאחוריהם.
      
      הכלים שרכשתי בתכנית מסייעים לי מדי יום בהובלת התאחדות יועצי המשכנתאות ובהדרכת יועצים חדשים. אני מאמין שהשילוב בין מקצועיות לרגישות חברתית הוא המפתח להצלחה בכל תחום.`
    },
    {
      name: 'איאד סלאח',
      cycle: "בוגר מחזור א'",
      ...
      fullText: `תכנית המנהיגות המגשרת ע"ש מאיר דגן ז"ל הייתה עבורי מסע מעצים ומשנה תפיסה. יצאתי עם רשת עמוקה של שותפים לדרך.
      
      כאיש חינוך מהמגזר הדרוזי, תכנית דגן העניקה לי הזדמנות ייחודית להכיר ולהתחבר עם מנהיגים מכל רחבי החברה הישראלית. למדתי שלמרות ההבדלים התרבותיים והדתיים, יש לנו הרבה מן המשותף.
      
      היום, בעבודתי כסגן מנהל בית ספר, אני מיישם את עקרונות המנהיגות המגשרת בחיי היומיום. אני מאמין שחינוך הוא המפתח לבניית גשרים בין קהילות, ותכנית דגן העניקה לי את הכלים להוביל מהלכים משמעותיים בתחום זה.`
    },
    {
      name: 'שרה סברו-כהן',
      cycle: "בוגרת מחזור ג'",
      ...
      fullText: `תכנית דגן עבורי היא חוויה מעצבת חיים ומסע עמוק של משמעות. יצאתי מהתכנית עם תובנה עמוקה ומודעות גבוהה יותר לצרכים המגוונים.
      
      כמנהלת בתחום הבריאות, אני נתקלת מדי יום באתגרים הנובעים מהשונות התרבותית בחברה הישראלית. תכנית דגן העניקה לי כלים להבין טוב יותר את הצרכים הייחודיים של קהילות שונות ולהתאים את שירותי הבריאות בהתאם.
      
      המפגשים עם מנהיגים מרקעים שונים הרחיבו את נקודת המבט שלי והעשירו את הגישה המקצועית שלי. אני מאמינה שבריאות איכותית ושוויונית היא זכות בסיסית של כל אדם, ותכנית דגן חיזקה את המחויבות שלי לעיקרון זה.`
    },
  ];
