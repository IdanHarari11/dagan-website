...
export default function Testimonials({ title }) {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      fullText: `הייתי חניך במחזור הראשון של "תוכנית דגן" – אחת החוויות המשמעותיות והמעצימות ביותר שחוויתי בשנים האחרונות. התוכנית, הנקראת על שמו של ראש המוסד לשעבר, מאיר דגן ז"ל, היא הרבה יותר ממסגרת לימודית – היא מסע אישי וחברתי שמשנה תפיסות, פותח דלתות ומעצב דור חדש של מנהיגים. התוכנית העניקה לי לא רק ידע, אלא שינוי תפיסתי עמוק. אחרי חודשים של מסע משמעותי, יצאתי ממנה אדם אחר – מודע יותר, מחויב יותר, נחוש לפעול למען החברה שלנו. למדתי שהמנהיגות מתחילה קודם כול בפנים, ביכולת לראות את המורכבויות ולנווט בתוכן, ביצירת חיבורים, בהובלת שינוי. במהלך התוכנית פגשתי נבחרת איכותית של אנשים שפועלים לטובת החברה, אנשים שהפכו לחברים ושותפים לדרך שילוו אותי במסע חיי. מספרים על מאיר דגן שהיה יהודי יצירתי, קשוח וחד כתער – אבל גם אנושי ובעל לב חם. מאחורי הפרויקט הייחודי הזה עומדים אנשים חדורי שליחות, לא פחות "פסיכים" ממנו, שמאמינים בכוחה של המנהיגות לחולל שינוי אישי וחברתי. `
    },
    {
    ...
    },
    {
      ...
      fullText: `הצטרפתי לתוכנית כדי לחזק את המיומנויות המנהיגותיות שבי כדי שאוכל להוביל שינויים בתחום שלי בצורה טובה יותר. אנחנו פועלים גם מול גופים רגולטוריים, גם מול חברי כנסת בהצעות חוק שונות, וגם מול גופי אשראי גדולים כמו הבנקים וצריך כדי לפעול במישורים האלו גם המון נחישות וגם לדעת מתי להיות סבלני ולראות את הצורך של הגוף שעומד מולנו כדי שנוכל לכוון את הדברים בצורה שתהיה טובה לציבור. הכרתי בתוכנית אנשים שלא דמיינתי שאכיר והתחזקתי בעצמי גם במיומנויות המנהיגות אבל גם במיומנויות אחרות של הקשבה והבנת כלל הציבוריים במדינת ישראל בצורה טובה יותר. למדנו לראות את העולם והחברה שלנו ממגוון זוויות ראייה מה שמאפשר להנהיג בצורה נכונה יותר בעתיד טוב יותר. התוכנית עזרה לי בצורה יוצאת דופן.`
    },
    {
      name: 'איאד סלמה',
      cycle: "בוגר מחזור א'",
      ...
      fullText: `תוכנית המנהיגות המגשרת ע”ש מאיר דגן ז”ל הייתה עבורי מסע מעצים ומשנה תפיסה! התוכנית העניקה לי כלים מעשיים להובלה ולגישור בין קהילות שונות, חידדה בי את החשיבות של הקשבה ודיאלוג, וחיזקה בי את תחושת האחריות האישית והחברתית שלי, בזכות התוכנית היוקרתית והסגל המקצועי המוביל יצאתי עם רשת עמוקה של שותפים לדרך ועם אמונה ביכולתי להשפיע וליצור שינוי אמיתי בחברה הישראלית!`
    },
    {
      name: 'שרה סברו-כהן',
      cycle: "בוגרת מחזור ג'",
      ...
      fullText: `תוכנית דגן עבורי היא הרבה יותר ממסגרת לימודית – היא הייתה חוויה מעצבת חיים, מסע עמוק של משמעות וחיבור לחברה הישראלית על כל גווניה ואתגריה. התוכנית פתחה בפניי נקודת מבט רחבה ומעמיקה על המורכבות החברתית בישראל, והחדירה בי את ההבנה שכל אתגר הוא הזדמנות לגשר, להוביל וליצור שינוי אמיתי. יצאתי מהתוכנית עם תובנה עמוקה ומודעות גבוהה יותר לצרכים המגוונים של הקהילות השונות, לצד כלים מעשיים להתמודדות עם אתגרים ניהוליים מורכבים – מתוך גישה של מנהיגות מגשרת, המחברת בין אנשים, ערכים ומטרות. מעבר לידע ולכלים, התוכנית העניקה לי מתנה גדולה: תחושת שליחות עמוקה ורצון עז לפעול למען חיזוק החברה הישראלית – בהקשבה, ברגישות ובאחריות.`
    },
  ];
