  ...
  const projects = [
    {
      ...
      fullDescription: `
        ...
        עד כה, הוכשרו מעל 500 עובדים ב-12 ארגונים שונים, והתכנית ממשיכה להתרחב.
      `,
    },
    {
      title: 'בין החיבורים',
      description: 'תכנית המחברת נערות ממגזרים שונים במפגשים שיטתיים, לשם יצירת חיבור אנושי, פתיחות והסרת דעות קדומות',
      image: 'https://t3.ftcdn.net/jpg/01/36/64/24/240_F_136642475_A4qy0YXpT82QpXOw9Thz8ncYUug091S9.jpg',
      // category: 'חיבור בין-תרבותי',
      fullDescription: `
        "בין החיבורים" היא תכנית חדשנית המפגישה נערות מרקעים תרבותיים שונים - יהודיות, ערביות, דתיות וחילוניות - במטרה לבנות גשרים של הבנה והערכה הדדית.
        
        התכנית פועלת במשך שנה שלמה וכוללת:
        ...
        התכנית פועלת כיום ב-8 ערים ברחבי הארץ ומשתתפות בה כ-200 נערות מדי שנה.
      `,
    },
    {
      title: 'דרך אבות',
